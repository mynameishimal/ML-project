...
random.seed(0)
torch.manual_seed(0)
log_filename='tuberculosis_resnet18_GB'
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        if i%10==0:
            ...
            if is_best:
                ...
                file_handlers.write('tuberculosis positive f1:'+str(mean(validation_performance['Tuberculosis_fscore'])))
