...
random.seed(0)
torch.manual_seed(0)
log_filename='pneumonia_HF'
writer  = SummaryWriter('covidDetectionWeightedBatchRuns/'+log_filename)
kernel_size = 3 

PATH = 'models/resnet18_flip_modelBest.model'
data_path = 'pneumoniaxray'
...
for epoch in range(epoch_runs):  # loop over the dataset multiple times
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        if i%10==0:
            ...
            validation_performance = add_performance(validaton_performance, "validation_accuracy", v_accuracy)
            ...
            if is_best:
                ...
                file_handlers.write('pnuemonia positive f1:'+str(mean(validation_performance['pneumoniaPos_fscore'])))
